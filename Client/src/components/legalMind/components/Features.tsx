export default function Features() {
  return (
    <div className="p-4 sm:ml-64 text-left lg:text-center">
      <div className="p-3 mt-16 lg:mt-28">
        <h1 className="mb-2 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl lg:text-5xl dark:text-white">
          Selamat Datang di <span className="text-red-600">Legalmind</span>
        </h1>
        ...
        <div className="fitur lg:grid lg:grid-cols-2 w-[600px] mx-auto grid gap-2 justify-start sm:justify-start">
          ...
          >
            <div className="title flex gap-3 items-center font-bold">
              <svg className="w-10 h-10 text-blue-800 rounded-xl bg-blue-600 p-2 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                <path
                  fillRule="evenodd"
            ...
            <svg className="w-7 h-7 ml-2 border border-gray-200 p-1 rounded-full items-center text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
          ...
          >
            <div className="title flex gap-3 items-center font-bold">
              <svg className="w-10 h-10 text-purple-800 rounded-xl  bg-purple-600 p-2 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
          ...
          >
            <div className="title flex gap-3 items-center font-bold">
              <svg className="w-10 h-10 text-green-800 rounded-xl bg-green-600 p-2 dark:text-whit" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                <path
                  fillRule="evenodd"
          ...
          >
            <div className="title flex gap-3 items-center font-bold">
              <svg className="w-10 h-10 text-red-800 rounded-xl bg-red-600 p-2 dark:text-whit" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
