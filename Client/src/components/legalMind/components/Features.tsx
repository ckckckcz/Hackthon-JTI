export default function Features() {
  return (
    <div className="p-4 sm:ml-64 text-left lg:text-center mr-[90px]">
      <div className="p-3 mt-16 lg:mt-28">
        ...
        <div className="fitur lg:grid lg:grid-cols-2 w-[600px] mx-auto grid gap-2 justify-start sm:justify-start">
          <a href="#" className="inline-flex lg:w-[290px] w-[330px] items-center justify-between px-5 py-3 text-base font-medium text-center text-black border border-gray-200 bg-white rounded-xl hover:bg-gray-100  mx-auto">
