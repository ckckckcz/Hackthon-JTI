...
const Navbar: React.FC = () => {
  ...
  <nav className="bg-white border-gray-200 dark:bg-gray-900">
    ...
    <a href="javascript:void(0)" className="flex items-center space-x-3 rtl:space-x-revers">
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/64/Jti_polinema.svg/1950px-Jti_polinema.svg.png" className="h-8" alt="JTI Logo" />
        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">JTI Berkas</span>
    </a>
